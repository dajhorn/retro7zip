...
#define SYNC_PARAM_DECL(x) NDOS::NSynchronization::CSynchro *x
#define SYNC_OBJ_DECL(x) NDOS::NSynchronization::CSynchro x;
...
typedef NDOS::NSynchronization::CBaseHandle_WFMO *CHandle_WFMO;
